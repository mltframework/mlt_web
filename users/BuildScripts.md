...
permalink: /documentation/buildscripts/
---
...
to set the MLT [Profiles]({{"/documentation/profiles" | prepend: site.baseurl }}) to use.
* Edit etc/melted.conf to include any [MVCP]({{"/documentation/mvcp" | prepend: site.baseurl }}) commands to
