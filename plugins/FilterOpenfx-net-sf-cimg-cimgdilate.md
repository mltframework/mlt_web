...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.net.sf.cimg.CImgDilate"
category: plugin
---
* TOC
{:toc}
...
media types:
Video  experimental  
description: Dilate (or erode) input stream by a rectangular structuring element of specified size and Neumann boundary conditions (pixels out of the image get the value of the nearest pixel).
