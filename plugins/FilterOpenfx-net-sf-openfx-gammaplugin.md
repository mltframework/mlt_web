...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.net.sf.openfx.GammaPlugin"
category: plugin
---
* TOC
{:toc}
...
media types:
Video  experimental  
description: Apply gamma function to the selected channels. The actual function is pow(x,1/max(1e-8,value)).  
version: 2  
