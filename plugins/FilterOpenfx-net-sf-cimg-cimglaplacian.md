...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.net.sf.cimg.CImgLaplacian"
category: plugin
---
* TOC
{:toc}
...
media types:
Video  experimental  
description: Blur input stream, and subtract the result from the input image. This is not a mathematically correct Laplacian (which would be the sum of second derivatives over X and Y).
