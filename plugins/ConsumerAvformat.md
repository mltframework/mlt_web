...
description:
store raw RGB bitmaps in VFW mode in bottom-up mode (matroska)  
type: string  
readonly: no  
required: no  
...
description:
control how a track&#39;s FlagDefault is inferred (matroska)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
store raw RGB bitmaps in VFW mode in bottom-up mode (webm)  
type: string  
readonly: no  
required: no  
...
description:
control how a track&#39;s FlagDefault is inferred (webm)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Enable Dolby Vision RPU coding (libaom-av1)  
type: string  
readonly: no  
required: no  
values:  
...
description:
Constant Rate Factor value (libsvtav1)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Initial Quantizer level value (libsvtav1)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Set the SVT-AV1 configuration using a :-separated list of key=value parameters (libsvtav1)  
type: string  
readonly: no  
required: no  
...
description:
Enable Dolby Vision RPU coding (libsvtav1)  
type: string  
readonly: no  
required: no  
values:  
...
description:
Enable Dolby Vision RPU coding (libx265)  
type: string  
readonly: no  
required: no  
values:  
...
description:
Set the encoding preset (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Set the encoding tuning info (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Set the encoding level restriction (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Set the encoding tier (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Override the preset rate-control (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Set the multipass encoding (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Enable 10 bit encode for 8 bit input (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Number of tile rows to encode with (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -1  
...
description:
Number of tile columns to encode with (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -1  
...
description:
Number of concurrent surfaces (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Selects which NVENC capable GPU to use. First GPU is 0, second is 1, and so on. (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Configure how nvenc handles packed RGB input. (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Delay frame output by the given amount of frames (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Number of frames to look ahead for rate-control (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Set target quality level (0 to 63, 0 means automatic) for constant quality mode in VBR rate control (av1_nvenc)  
type: float  
readonly: no  
required: no  
minimum: 0  
...
description:
Initial QP value for P frame (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -1  
...
description:
Initial QP value for B frame (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -1  
...
description:
Initial QP value for I frame (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -1  
...
description:
Constant quantization parameter rate control method (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -1  
...
description:
Quantization parameter offset for cb channel (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -12  
...
description:
Quantization parameter offset for cr channel (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: -12  
...
description:
When lookahead is enabled, set this to 1 to disable adaptive I-frame insertion at scene cuts (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
If forcing keyframes, force them as IDR frames. (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
When lookahead is enabled, set this to 0 to disable adaptive B-frame decision (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
set to 1 to enable Spatial AQ (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
set to 1 to enable Temporal AQ (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Set 1 to indicate zero latency operation (no reordering delay) (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Set this to 1 to enable automatic insertion of non-reference P-frames (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Set 1 to minimize GOP-to-GOP rate fluctuations (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
When Spatial AQ is enabled, this field is used to specify AQ strength. AQ strength scale is from 1 (low) - 15 (aggressive) (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 1  
...
description:
Enable weighted prediction (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Use B frames as references (av1_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Specifies the DPB size used for encoding (0 means automatic) (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Low delay key frame scale; Specifies the Scene Change frame size increase allowed in case of single frame VBV and CBR (av1_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Use Periodic Intra Refresh instead of IDR frames (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Include timing info in sequence/frame headers (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Pass on extra SEI data (e.g. a53 cc) to be included in the bitstream (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Use A53 Closed Captions (if available) (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Use timecode (if available) (av1_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Configure how nvenc handles packed RGB input. (h264_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Use B frames as references (h264_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Use A53 Closed Captions (if available) (h264_nvenc)  
type: string  
readonly: no  
required: no  
...
description:
Specifies the DPB size used for encoding (0 means automatic) (h264_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Maximum encoded slice size in bytes (h264_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Configure how nvenc handles packed RGB input. (hevc_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Use B frames as references (hevc_nvenc)  
type: string  
readonly: no  
required: no  
format: integer or keyword  
...
description:
Specifies the DPB size used for encoding (0 means automatic) (hevc_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
...
description:
Maximum encoded slice size in bytes (hevc_nvenc)  
type: integer  
readonly: no  
required: no  
minimum: 0  
