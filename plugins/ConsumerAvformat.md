...
title: Redirect I/O  description:
...
title: Display aspect ratio numerator  type: integer
readonly: no
required: no
minimum: 0  
...
title: Display aspect ratio denominator  type: integer
readonly: no
required: no
minimum: 0  
...
title: Display aspect ratio  type: 
readonly: true
required: no

### sample_aspect_num

title: Sample aspect ratio numerator  type: integer
readonly: no
required: no
minimum: 0  
...
title: Sample aspect ratio denominator  type: integer
readonly: no
required: no
minimum: 1  
...
title: Progressive  type: integer
readonly: no
required: no
minimum: 0  
maximum: 1  
...
title: Frame rate numerator  type: integer
readonly: no
required: no
minimum: 0  
unit: frames/second  
...
title: Frame rate denominator  type: integer
readonly: no
required: no
minimum: 1  
unit: frames/second  
...
title: Deinterlacer  type: string
readonly: no
required: no
default: yadif  
values:
...
title: Image scaler  description:
...
title: Audio sample rate  type: integer
readonly: no
required: no
minimum: 0  
maximum: 256000  
...
title: Channels on track 1  description:
...
title: Channels on track 2  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Channels on track 3  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Channels on track 4  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Channels on track 5  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Channels on track 6  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Channels on track 7  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Channels on track 8  description:
Used to map a bundle of channels to multi-track audio.  
type: integer
readonly: no
required: no
...
title: Aspect ratio  description:
...
title: Audio channels  description:
...
title: Audio sample rate  description:
...
title: Encoding threads  type: integer
readonly: no
required: no
minimum: 0  
maximum: 16  
...
title: Audio quality  description:
...
title: Intra DC precision  type: integer
readonly: no
required: no
default: 8  
...
title: Muxer preload  description:
...
title: Audio FourCC  type: string
readonly: no
required: no

### apre

title: Audio codec preset  type: string
readonly: no
required: no

### vpre

title: Video codec preset  type: string
readonly: no
required: no

### fpre

title: Format preset  type: string
readonly: no
required: no

### alang

title: Audio language  description:
...
title: Pixel format  description:
...
title: Video quantizer  description:
...
title: Video FourCC  type: string
readonly: no
required: no

### rc_override

title: Rate control  description:
...
title: Two-pass log file  type: string
readonly: no
required: no

### vb

title: Video bitrate  description:
...
title: Audio bitrate  description:
Normally this is an integer, but you can append a K suffix for convenience.  
type: string
readonly: no
required: no
...
title: Disable audio  type: integer
readonly: no
required: no
minimum: 0  
maximum: 1  
...
title: Disable video  type: integer
readonly: no
required: no
minimum: 0  
maximum: 1  
...
description:
Flags common for all mpegvideo-based encoders. (snow)  
type: string
readonly: no
required: no
format: flags  
...
description:
single coefficient elimination threshold for luminance (negative values also consider dc coefficient) (snow)  
type: integer
readonly: no
required: no
default: 0  
...
description:
single coefficient elimination threshold for chrominance (negative values also consider dc coefficient) (snow)  
type: integer
readonly: no
required: no
default: 0  
...
description:
Simulate errors in the bitstream to test error concealment. (snow)  
type: integer
readonly: no
required: no
minimum: 0  
...
description:
how to keep quantizer between qmin and qmax (0 = clip, 1 = use differentiable function) (snow)  
type: float
readonly: no
required: no
minimum: 0  
...
description:
experimental quantizer modulation (snow)  
type: float
readonly: no
required: no
default: 0  
...
description:
initial complexity for 1-pass encoding (snow)  
type: float
readonly: no
required: no
default: 0  
...
description:
increase the quantizer for macroblocks close to borders (snow)  
type: float
readonly: no
required: no
default: 0  
...
description:
minimum Lagrange factor (VBR) (snow)  
type: integer
readonly: no
required: no
minimum: 0  
...
description:
maximum Lagrange factor (VBR) (snow)  
type: integer
readonly: no
required: no
minimum: 0  
...
description:
Always write luma and chroma matrix for mjpeg, useful for rtp streaming. (snow)  
type: string
readonly: no
required: no
...
description:
Strategy to choose between I/P/B-frames (snow)  
type: integer
readonly: no
required: no
minimum: 0  
...
description:
Adjust sensitivity of b_frame_strategy 1 (snow)  
type: integer
readonly: no
required: no
minimum: 1  
...
description:
Downscale frames for dynamic B-frame decision (snow)  
type: integer
readonly: no
required: no
minimum: 0  
...
description:
Frame skip compare function (snow)  
type: string
readonly: no
required: no
format: integer or keyword  
...
description:
Use MPEG quantizers instead of H.263 (snow)  
type: integer
readonly: no
required: no
minimum: 0  
...
description:
RTP payload size in bytes (snow)  
type: integer
readonly: no
required: no
default: 0  
...
description:
Motion estimation bitrate penalty compensation (1.0 = 256) (snow)  
type: integer
readonly: no
required: no
default: 0  
