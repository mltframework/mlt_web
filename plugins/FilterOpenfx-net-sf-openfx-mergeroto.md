...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.net.sf.openfx.MergeRoto"
category: plugin
---
* TOC
{:toc}
...
media types:
Video  experimental  
description: Pixel-by-pixel merge operation between two inputs using and external alpha channel for input A.
