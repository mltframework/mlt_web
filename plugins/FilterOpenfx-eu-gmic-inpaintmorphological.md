...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.eu.gmic.Inpaintmorphological"
category: plugin
---
* TOC
{:toc}
...
title: GMIC Inpaint morphological  
media types:
Video  experimental  
...
required: no  
animation: yes  
default: Note: It is strongly suggested to apply this filter only on a selection around the region to inpaint, to save computation time!  
