...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.net.sf.openfx.TransformMaskedPlugin"
category: plugin
---
* TOC
{:toc}
...
title: TransformMaskedOFX  
media types:
Video  experimental  
description: Translate / Rotate / Scale a 2D image, with optional masking.
