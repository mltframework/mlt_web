...
layout: standard
title: Documentation
wrap_title: "Filter: openfx.eu.gmic.BWfilms"
category: plugin
---
* TOC
{:toc}
...
required: no  
animation: yes  
default: Note: The color LUTs used in this section have been designed by Patrick David. More info at:  
...
required: no  
animation: yes  
default: Authors: Patrick David and David Tschumperle.      Latest update: 2016/02/08.  
